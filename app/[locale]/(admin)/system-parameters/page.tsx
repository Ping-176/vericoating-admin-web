...
export default async function SystemParametersPage({
  ...
  return (
    <>
      <PageHeader title={t.systemParameters} description={t.systemParametersDesc} />
      ...
      <SystemParametersWorkspace locale={locale} t={t} systems={systems} parameters={parameters} />
    </>
  );
}
