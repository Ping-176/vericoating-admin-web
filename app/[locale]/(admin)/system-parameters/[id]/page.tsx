...
export default async function SystemParameterDetailPage({
  params,
  searchParams,
}: {
  ...
  return (
    <>
      ...
      <SystemParametersWorkspace locale={locale} t={t} systems={systems} parameters={parameters} initialSelectedId={id} />
    </>
  );
}
