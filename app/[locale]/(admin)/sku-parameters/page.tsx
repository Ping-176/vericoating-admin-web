...
export default async function SkuParametersPage({
  params,
  searchParams,
}: {
  ...
  return (
    <>
      <PageHeader title={t.skuParameters} description={t.skuParametersDesc} />
      ...
      <SkuParametersWorkspace locale={locale} t={t} skus={skus} systems={systems} parameters={parameters} />
    </>
  );
}
