...
export default async function SkuParameterDetailPage({
  params,
  searchParams,
}: {
  ...
  return (
    <>
      ...
      <SkuParametersWorkspace locale={locale} t={t} skus={skus} systems={systems} parameters={parameters} initialSelectedId={id} />
    </>
  );
}
